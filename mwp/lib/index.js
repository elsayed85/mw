...
const logger = {
  ...
  log: (k, v) => {
    var _a;
    (_a = logger.logs)[k] ?? (_a[k] = []);
    logger.logs[k].push(v);
  },
  clear: () => {
    logger.logs = {};
  }
...
const wasmUrl = "data:application/wasm;base64,";
...
async function decode$1(text) {
  const base = "0123456789abcdefghijklmnopqrstuwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
  const buffer = [];
  let n = Array.from(text).reduce((x, c) => x * BigInt(base.length) + BigInt(base.indexOf(c)), 0n);
  for (; n > 0n; n >>= 8n)
    buffer.push(Number(n & 255n));
  const blob = new Blob([new Uint8Array(buffer.reverse())]);
...
async function decryptWasm(encryptedText, tmdbId) {
  const response = await sendRequest$1(wasmUrl);
  const { instance } = await WebAssembly.instantiate(await response.arrayBuffer(), { env: { abort: () => {
  } } });
  const memory = instance.exports.memory;
  const writeStart = instance.exports.__new(encryptedText.length << 1, 2) >>> 0;
  const writeBuffer = new Uint16Array(memory.buffer);
  Array.from(encryptedText).forEach((e, i) => {
    writeBuffer[(writeStart >>> 1) + i] = e.charCodeAt(0);
  });
  const readStart = instance.exports.decrypt(writeStart, tmdbId) >>> 0;
  const readEnd = readStart + new Uint32Array(memory.buffer)[readStart - 4 >>> 2] >>> 1;
    ...
    stream: [
      {
        ...
        captions: res.subtitles.map((s) => ({
          ...
          url: s.url,
          hasCorsRestrictions: false,
          language: labelToLanguageCode(s.language.split(" ")[0]) ?? s.language
        })),
        type: "file",
        qualities: Object.fromEntries(
          res.sources.map((s) => [getValidQualityFromString(s.quality), { url: s.url }])
        )
      }
    ]
  };
}
const braflixFrom = (source) => (ctx) => braflixScraper(source, ctx);
makeSourcerer({
  id: "superstream",
  name: "SuperStream",
  rank: 1190,
  flags: [flags.CORS_ALLOWED],
  disabled: true,
  scrapeMovie: braflixFrom("superstream"),
  scrapeShow: braflixFrom("superstream")
});
const febboxScraper = makeSourcerer({
  ...
  flags: [flags.CORS_ALLOWED],
  disabled: false,
  scrapeMovie: braflixFrom("charlie"),
  scrapeShow: braflixFrom("charlie")
});
const vidSrcToScraper = makeSourcerer({
  ...
  scrapeShow: braflixFrom("vidsrcto")
});
const goMoviesScraper = makeSourcerer({
  ...
  flags: [flags.CORS_ALLOWED],
  disabled: false,
  scrapeMovie: braflixFrom("gomovies"),
  scrapeShow: braflixFrom("gomovies")
});
...
makeSourcerer({
  ...
  flags: [flags.CORS_ALLOWED],
  disabled: true,
  scrapeMovie: braflixFrom("vidsrc"),
  scrapeShow: braflixFrom("vidsrc")
});
...
const uids = JSON.parse(atob(""));
const _uids = uids.filter((x) => ![20015527].includes(x));
const uid = _uids[Math.floor(Date.now() / 864e5) % _uids.length];
...
const sendRequest = async (ctx, data2, altApi = true) => {
  const defaultData = {
    childmode: "0",
    app_version: "11.5",
    appid: appId,
  ...
  logger.log("showbox", data2);
  try {
    const json = JSON.parse(response);
    if (data2.module === "Search5" && json.code !== 1) {
      logger.log("showbox", json);
    }
    if (["Movie_downloadurl_v3", "TV_downloadurl_v3"].includes(data2.module)) {
      const filterKeys = ["path", "real_quality", "size", "filename"];
      const filterFunc = (o) => Object.fromEntries(filterKeys.map((k) => [k, o[k]]));
      logger.log("showbox", json.data.list.map(filterFunc));
    }
  } catch (error) {
    logger.log("showbox", response);
  }
...
async function getSubtitles(ctx, id, fid, type, episodeId, seasonId) {
  ...
  subtitleList.forEach((sub) => {
    ...
    if (!subtitle)
      return;
    const subtitleFilePath = subtitle.file_path.replace(captionsDomains[0], captionsDomains[1]).replace(/\s/g, "%20").replace(/[()]/g, (c) => {
...
const baseUrl$6 = "https://autoembed.cc/";
...
async function comboScraper$1(ctx) {
  ...
  if (!showboxEntry) {
    const filterFunc = (o) => Object.fromEntries(["title", "year"].map((k) => [k, o[k]]));
    logger.log("showbox", searchRes.map(filterFunc));
